...
public class DriverController {
	...
	public ResponseEntity<Driver> updateDriverHandler( @Valid @PathVariable("driverId") Integer driverId,@RequestBody Driver driver) throws DriverException{
		 Driver updatedDriver=sDriver.updateDriver(driverId, driver);
