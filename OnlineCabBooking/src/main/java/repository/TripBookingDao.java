...
//	
//	@Query("select t from TripBooking t where t.CustomerId =?1 &t.status=1")
...
//	
//	@Query("select t from TripBooking t where t.CustomerId= ?1 and t.fromDateTime=?2 and t.toDateTime=?3")
